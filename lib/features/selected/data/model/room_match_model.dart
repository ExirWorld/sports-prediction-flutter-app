...
class RoomMatchModel extends RoomMatchEntity {
  ...
  factory RoomMatchModel.fromJson(Map<String, dynamic> json) {
    return RoomMatchModel(
      ...
      allTokenValue: json['allTokenValue'] as int?,
      tokenDepositValue: json['tokenDepositValue'] as int?,
      seatCount: json['seatCount'] as int?,
      winnerSeatVal: json['winnerSeatVal'] as int?,
      looserSeatVal: json['looserSeatVal'] as int?,
