...
class RoomMatchModel extends RoomMatchEntity {
  const RoomMatchModel({
    ...
    super.seatCount,
    super.winnerSeatValStr,
    super.looserSeatValStr,
    super.status,
    super.desc,
    super.createDate,
  });
  ...
  factory RoomMatchModel.fromJson(Map<String, dynamic> json) {
    return RoomMatchModel(
      ...
      winnerSeatValStr: json['winnerSeatValStr'] as String?,
      looserSeatValStr: json['looserSeatValStr'] as String?,
  ...
  Map<String, dynamic> toJson() => {
        ...
        'seatCount': seatCount,
        'winnerSeatValStr': winnerSeatValStr,
        'looserSeatValStr': looserSeatValStr,
        'status': status,
        'desc': desc,
